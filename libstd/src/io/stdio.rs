...
use crate::io::{self, BufReader, Initializer, LineWriter};
...
pub fn stderr() -> Stderr {
    // Stderr { inner: &ReentrantMutex::new(RefCell::new(Maybe::Real(stderr_raw()))) }
    ...
    //     }
    // });
    *INSTANCE.lock().borrow_mut() = Maybe::Real(stderr_raw().unwrap());
