...
use crate::syscall::{SyscallOp, MsgInfo, syscall};
use crate::error::{SysResult, SysError};

#[derive(Debug, Clone, Copy)]
pub enum IdentifyResult {
    NullObj,
    Untyped {paddr: usize, bit_sz: u8, is_device: bool, free_offset: usize},
    CNode {bit_sz: u8},
    Tcb,
